...
export class QuoteComponent implements OnInit {
     quotes:Quote[] = [
      new Quote(1, 'Charles', 'Living Life', 'Live as if you were to die tomorrow. Learn as if you were to live forever','Milton Berle',new Date(2021,3,14),0,0),
      ...
      new Quote(5, 'Carter', 'Important Wisdom', 'Wise men speak because they have something to say; fools because they have to say something','Bernard M. Baruch',new Date(2021,3,14),0,0),
